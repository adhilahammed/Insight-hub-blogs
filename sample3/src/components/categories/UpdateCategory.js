...
import {  deleteCategoriesAction, fetchCategoryAction, updateCategoriesAction } from "../../redux/slice/category/categorySlice";
...
dispatch(fetchCategoryAction(id))
    ...
    const {appErr,category,loading,serverErr,isEdited,isDeleted}=state
