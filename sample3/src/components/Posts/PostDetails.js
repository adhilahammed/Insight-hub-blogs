...
import { deletePostAction, fetchPostDetailsAction } from "../../redux/slice/posts/postSlices";
...
const PostDetails = ({
  ...
  console.log(isCreatedBy);
   ...
   //redirect
   if (isDeleted) return <Redirect to="/get-posts" />;
  return (
    <>
      {loading ? (
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div class="max-w-xl mx-auto">
                <p class="mb-6 text-left  text-xl text-gray-200">
                  ...
                  <div  class="text-white" dangerouslySetInnerHTML={sanitizedData(postDetails?.description)}></div>
