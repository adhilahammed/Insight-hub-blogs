...
import { dislikeAction, fetchPostsAction, likeAction } from "../../redux/slice/posts/postSlices";

import DateFormatter from "../../utils/Dateformatter";
import { fetchCategoriesAction } from "../../redux/slice/category/categorySlice";
            ...
            <div class="flex flex-wrap -mx-3">
              ...
              <div class="w-full lg:w-3/4 px-3">
                ...
                { appErr || serverErr ? (
                  ...
                  postLists?.slice(pagesVisited,pagesVisited+usersPerPage).map(post => (
                    <div
                    key={post.id}
                     class="flex flex-wrap bg-gray-900 -mx-3  lg:mb-6">
                      <div class="mb-10  w-full lg:w-1/4 px-3">
                        ...
                        <div className="flex flex-row bg-gray-300 justify-center w-full  items-center ">
                          ...
                          <ThumbDownIcon 
                          onClick={()=>{
                            dispatch(dislikeAction(post?._id))
                          }}
                      ...
                      <div class="w-full lg:w-3/4 px-3">
                        ...
                        <div style={{overflow: "hidden", textOverflow: "ellipsis",height:'100px' }} class="text-white" dangerouslySetInnerHTML={sanitizedData(post?.description)}></div>
                        {/* Read more */}
                        <Link to={`/post/${post?._id}`} className="text-indigo-500 hover:underline">
                          Read More..
                        </Link>
                        {/* User Avatar */}
